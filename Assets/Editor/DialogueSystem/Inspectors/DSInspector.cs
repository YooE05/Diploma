...
namespace DS.Inspectors
{
    ...
    public class DSInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            string dialogueFolderPath = $"Assets/Game/Modules/DialogueSystem/Dialogues/{currentDialogueContainer.FileName}";
        ...
        private void DrawDialogueGroupArea(DSDialogueContainerSO dialogueContainer, List<string> dialogueGroupNames)
        {
            ...
            DSDialogueGroupSO selectedDialogueGroup = DSIOUtility.LoadAsset<DSDialogueGroupSO>($"Assets/Game/Modules/DialogueSystem/Dialogues/{dialogueContainer.FileName}/Groups/{selectedDialogueGroupName}", selectedDialogueGroupName);
