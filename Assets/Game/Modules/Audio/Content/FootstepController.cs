...
namespace Audio.Content
{
    public sealed class FootstepController : MonoBehaviour
    {
        ...
        [Range(0.0f, 2.0f)] [SerializeField] private float _minPitch = 1.0f;
        [Range(0.0f, 2.0f)] [SerializeField] private float _maxPitch = 1.5f;
        ...
        private void Update()
        {
            if (Input.GetKey(KeyCode.W))
            {
                    ...
                    Random.Range(_minTimeBetweenFootsteps, _maxTimeBetweenFootsteps))
                {
                    ...
                    AudioManager.Instance.PlaySoundOneShot(footstepSound, _character.position,
