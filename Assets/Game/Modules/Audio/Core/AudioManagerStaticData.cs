namespace Audio
{
    ...
    {
        public const string AUDIO_MIXER_RESOURCE_NAME = "AudioMixer";
        public const string AUDIO_LIBRARY_RESOURCE_NAME = "AudioLibrary";
        public const string AUDIO_LAYER_SETTING_RESOURCE_NAME = "AudioLayerSetting";
        
        public const string SOUNDS_MAIN_CHANNEL_NAME = "SoundsMainChannel";
        public const string SOUNDS_UI_CHANNEL_NAME = "SoundsUiChannel";
